...
// --- DEFAULT BACKGROUND IMAGES (ภาพสำรอง) ---
const DEFAULT_BGS = {
    WOOD: [
...
function switchSystem(system) {
    ...
    if (hasImages) {
        ...
        // Create Bento Grid Container with FORCED STYLES (แก้บั๊ก CSS ไม่โหลด)
        ...
        [0, 1, 2].forEach(colIndex => {
            ...
            if (colImgs.length > 0) {
                colImgs.forEach((url, imgIdx) => {
                    ...
                    // --- ANIMATION & STYLES (Smooth Crossfade & Zoom) ---
                    ...
                    slide.style.transition = 'opacity 3s ease-in-out, transform 8s linear'; // Smooth Transition
                    slide.style.opacity = imgIdx === 0 ? '1' : '0';
                    slide.style.transform = imgIdx === 0 ? 'scale(1.1)' : 'scale(1)';
                    slide.style.zIndex = imgIdx === 0 ? '1' : '0';
                ...
                if (colImgs.length > 1) {
                    ...
                    setTimeout(() => {
                        const interval = setInterval(() => {
                            ...
                            slides[cur].style.transform = 'scale(1.1)'; // Start Zoom
